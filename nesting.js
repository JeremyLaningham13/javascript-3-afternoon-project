...
function employeeUpdater() {
  let filterEmployees = employees.filter(function(element, index, array) {
    return element.firstName !== "Theo";
  });

  let filterEmployees_2 = filterEmployees.map(function(element, index, array) {
